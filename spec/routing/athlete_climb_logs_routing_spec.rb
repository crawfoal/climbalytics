...
RSpec.describe AthleteClimbLogsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #index" do
      expect(:get => "/athlete_climb_logs").to route_to("athlete_climb_logs#index")
    end
    ...
    it "routes to #show" do
      expect(:get => "/athlete_climb_logs/1").to route_to("athlete_climb_logs#show", :id => "1")
    end
    ...
    it "routes to #destroy" do
      expect(:delete => "/athlete_climb_logs/1").to route_to("athlete_climb_logs#destroy", :id => "1")
    end
